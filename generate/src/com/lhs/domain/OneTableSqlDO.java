...
public class OneTableSqlDO {
	...
	/** 创建时间字段属性名称 */
	private String createDatePropertyName;
	...
	public String getCreateDatePropertyName() {
		return createDatePropertyName;
	}

	public void setCreateDatePropertyName(String createDatePropertyName) {
